...
if __name__ == r"__main__":
    ...
    parser.add_argument(r"--restore_path", type=str, required=True)
    args = parser.parse_args()
    eer, eval_iteration = evaluate_performance(trial_file=r"cnceleb_trials.txt",
                                               checkpoint_path=args.restore_path,
                                               hp=hparams)
    print(args.restore_path)
    print(r"CN-Celeb EER: {}".format(eer))
